    ...
    Scaffold(
        ...
        Box(
            ...
            Column(
                modifier = Modifier
                    .fillMaxSize()
                    .padding(top = 0.dp), // Ajuste de padding superior para espaçamento global
                ...
                Image(
                    ...
                    modifier = Modifier
                        .size(250.dp, 300.dp)
                        .padding(bottom = 20.dp, top = 100.dp) // Padding individual para o logo
                )
                ...
                Text(
                    ...
                    modifier = Modifier
                        .padding(bottom = 20.dp, top = 0.dp), // Padding individual para o texto
                    fontSize = 22.sp,
                    letterSpacing = 2.sp,
                ...
                Text(
                    text = "Para recuperares a tua conta, enviaremos um e-mail de confirmação para a tua caixa de entrada. Por favor, colaca o teu e-mail no campo abaixo.",
                    fontWeight = FontWeight.Medium,
                    modifier = Modifier
                        .padding(bottom = 20.dp, end = 15.dp, start= 10.dp), // Padding individual para o texto
                    fontSize = 14.sp,
                    letterSpacing = 1.sp,
                    textAlign = TextAlign.Center,
                    color = Color.hsl(172f,0.23f,0.46f)
                )
                // Texto "E-MAIL"
                Text(
                    text = "E-MAIL",
                ...
                // Botão Criar Conta
                LoginButton("ENVIAR CÓDIGO",
                    AmigosActivity::class.java)

                Spacer(modifier = Modifier.height(160.dp))
                LoginButton("Voltar para Login",
                    AmigosActivity::class.java)
            }
        }
    }
